...
public class Population {
    ...
    /**
     * In each generation, the fittest half is selected for the next generation.
     * Two parents are selected from the fittest half by random.
     * The children are generated by crossover and mutation.
     * @param crossoverRate How likely that the parents common genes are copied to the offspring.
     * @param mutationRate How likely that a gene is mutated.
     */
    ...
    /**
     * If the parents have the same genes, the offspring will likely have the same genes, determined by the crossoverRate.
     * @param parents The selected parents to be crossed.
     * @param crossoverRate The probability that the parents common genes are copied to the offspring.
     * @return The child.
     */
    @SneakyThrows
